...
Phaser.Create.prototype = {
     ...
     * @return {?PIXILegacy.Texture|Phaser.BitmapData} The newly generated texture, or a new BitmapData object if `generateTexture` is false, or `null` if a callback was passed and the texture isn't available yet.
     */
