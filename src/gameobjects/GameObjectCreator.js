...
Phaser.GameObjectCreator.prototype = {
    ...
    * @param {string|Phaser.RenderTexture|PIXILegacy.Texture} key - This is the image or texture used by the Sprite during rendering. It can be a string which is a reference to the Cache entry, or an instance of a RenderTexture or PIXILegacy.Texture.
    ...
    * @param {string|Phaser.RenderTexture|Phaser.BitmapData|PIXILegacy.Texture} key - This is the image or texture used by the TileSprite during rendering. It can be a string which is a reference to the Cache entry, or an instance of a RenderTexture or PIXILegacy.Texture.
